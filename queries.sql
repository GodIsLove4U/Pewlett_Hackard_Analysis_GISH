...
-- Joining retirement_info and dept_emp tables into new table
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	de.to_date
...
-- Create table for Sales department
SELECT ce.emp_no,
	ce.first_name,
	ce.last_name,
	d.dept_name	
...
-- Create table for Sales & Development departments
SELECT ce.emp_no,
	ce.first_name,
	ce.last_name,
	d.dept_name	
INTO sales_and_devel_dept_info
FROM current_emp as ce
	INNER JOIN dept_emp AS de
		ON (ce.emp_no = de.emp_no)
	INNER JOIN departments AS d
...
DROP TABLE emp_info_with_title
...
FROM employees as emp LEFT JOIN titles
	...
	--AND (emp.hire_date BETWEEN '1965-01-01' AND '1965-12-31')
	--Above clause produces no employees hired in the range
